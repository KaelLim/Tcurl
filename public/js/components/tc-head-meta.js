 ...
 * Injects shared <head> resources: favicon, fonts, Material Symbols
 *
 * NOTE: Tailwind CDN + config must remain inline in HTML (synchronous loading required).
 * This component only handles resources that can load asynchronously.
 *
