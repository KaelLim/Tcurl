 ...
 */
export const QR_THEMES: Record<string, QRTheme> = {
  // 慈濟藍（預設）
  'tzu-chi-blue': {
    id: 'tzu-chi-blue',
    name: '慈濟藍',
 ...
 * 根據主題 ID 取得主題設定
 */
export function getTheme(themeId: string): QRTheme | null {
 ...
 * 取得預設主題
 */
export function getDefaultTheme(): QRTheme {
 ...
 * 取得所有可用主題列表
 */
export function getAllThemes(): QRTheme[] {
